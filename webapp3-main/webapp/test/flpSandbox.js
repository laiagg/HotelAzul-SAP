		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicación Fiori",
									"targetURL": "#AplicaciónFiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AplicaciónFiori-display": {
								"semanticObject": "AplicaciónFiori",
								"action": "display",
								"description": "Ejercicio Fiori",
								"title": "Aplicación Fiori",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori",
									"url": sap.ui.require.toUrl("fiori")
								}
							}
						}
					}
